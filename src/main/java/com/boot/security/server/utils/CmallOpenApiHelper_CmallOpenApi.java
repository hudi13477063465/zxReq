...
public class CmallOpenApiHelper_CmallOpenApi extends ApacheHttpClient {

    public final static String HOST     = "cmallopenapi.citic-mall.com";

    static CmallOpenApiHelper_CmallOpenApi  instance = new CmallOpenApiHelper_CmallOpenApi();


    public static CmallOpenApiHelper_CmallOpenApi getInstance() {
        return instance;
    }
     ...
     */
    public ApiResponse sendCmallOpenApisyncMode(String subUrl, String v, String appId) {
        ...
        request.addParam("X-Ca-Stage", "TEST", ParamPosition.HEAD, true);
